...
test -f swoole-cli-build-dev-1-container.txt && image=$(cat container/swoole-cli-build-dev-1-container.txt)
test -f swoole-cli-build-dev-1-container.txt || image=$default_image
