...
./var/runtime/php/php -c ./var/runtime/php/php.ini  sync-source-code.php
./var/runtime/php/php -c ./var/runtime/php/php.ini  sync-source-code.php --action run
